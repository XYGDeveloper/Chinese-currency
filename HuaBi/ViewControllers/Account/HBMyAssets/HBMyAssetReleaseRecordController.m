...
- (void)viewDidLoad {
    ...
    self.title = kLocat(@"Assert_detail_releaserecord");
...
-(void)loadDataWith:(NSInteger)page
{
    ...
    NSString *api = self.isPresentation ? @"/AccountManage/getCurrencyLockFreedList_award" : @"/AccountManage/getCurrencyLockFreedList";
