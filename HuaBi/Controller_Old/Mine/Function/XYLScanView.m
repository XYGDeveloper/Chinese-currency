...
- (UIView *)creatLine{
    ...
    if (_lineMode == XYLScaningLineModeDeafult) {
        line.backgroundColor = kYellowColor;
    ...
    if (_lineMode == XYLScaningLineModeImge) {
        ...
        UIImageView *v = [[UIImageView alloc]initWithImage:[UIImage imageNamed:kScanLineImageName]];

//        v.contentMode = UIViewContentModeScaleAspectFill; 
        v.frame = CGRectMake(0, 0, line.frame.size.width, line.frame.size.height);
//        v.frame = CGRectMake(0, 0, line.frame.size.width, 1);
    ...
    if (_lineMode == XYLScaningLineModeGrid) {
        ...
        line.frame = frame;
        UIImageView *iv = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"two_card_line"]];
...
- (void)addCornerLineWithContext:(CGContextRef)ctx rect:(CGRect)rect{
    ...
    // 244 104 60
    CGContextSetRGBStrokeColor(ctx, 0.16, 0.67, 0.15, 1);//橘色
...
- (void)showLine
{
    if (_lineMode == XYLScaningLineModeDeafult)
    {
        ...
        shadowLine.backgroundColor = kYellowColor;
