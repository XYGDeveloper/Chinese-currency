...
@interface HBTeamViewController ()<ApiRequestDelegate,UITableViewDelegate,UITableViewDataSource>
...
@implementation HBTeamViewController
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = kLocat(@"HBRewardViewController_s3_1");
    ...
    self.header.countDes.text = kLocat(@"HBRewardViewController_s3_1_1");
