...
@interface WSActionSheetBlock()<UIActionSheetDelegate,ELCImagePickerControllerDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UIAlertViewDelegate>
    ...
    if (buttonIndex == [actionSheet cancelButtonIndex]) {
        ...
        if (buttonIndex == 0) {
            ...
            if ([self isVideoUseable] == NO) {
                ...
                UIAlertView *alert = [[UIAlertView alloc]initWithTitle:nil message:@"相机权限未开通，请前往设置打开" delegate:self cancelButtonTitle:@"取消" otherButtonTitles:@"确定", nil];
                [alert show];
                return;
            }
