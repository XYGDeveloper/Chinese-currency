...
- (void)creatButton
{
    ...
    UIButton *backButton = [[UIButton alloc] initWithFrame:kRectMake(50, 50, 50, 50)];
    [backButton setImage:kImageFromStr(@"a_img") forState:UIControlStateNormal];
...
//            [button setImage:[UIImage imageNamed:@"smaller"] forState:UIControlStateSelected];
            ...
            [button setImage:[UIImage imageNamed:@"smaller"] forState:UIControlStateNormal];
            [button setImage:[UIImage imageNamed:@"smaller"] forState:UIControlStateSelected];
