...
- (void)createUI
{
    ...
    [self.closeButton mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_equalTo(XX_6(18));
    }];
...
- (UIButton *)closeButton
{
    if (!_closeButton)
    {
        ...
        [_closeButton setBackgroundImage:[UIImage imageNamed:@"back_paymode"] forState:UIControlStateNormal];
...
- (UIButton *)forgetPasswordButton
{
    if (!_forgetPasswordButton)
    {
        ...
        [_forgetPasswordButton setTitleColor:kColorFromStr(@"#4C9EE4") forState:UIControlStateNormal];
