...
-(void)yee_MakeBadgeText:(NSString *)text
    ...
    if ([self isKindOfClass:[UIButton class]]) {
        ...
        [[self  yee_BadgeLable] makeBrdgeViewWithText:text textColor:tColor backColor:backColor textFont:tfont tframe:CGRectMake(weakButton.imageView.frame.size.width*0.5+weakButton.imageView.frame.origin.x,weakButton.imageView.frame.origin.y - 5, textSize.width+8.0, textSize.height)];
    }else{
