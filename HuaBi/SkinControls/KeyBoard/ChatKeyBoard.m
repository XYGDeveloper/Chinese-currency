...
+ (instancetype)keyBoardWithNavgationBarTranslucent:(BOOL)translucent
{
    ...
    if (translucent) {
        ...
        frame = CGRectMake(0, kScreenHeight - kChatToolBarHeight - kNavigationBarHeight, kScreenWidth, kChatKeyBoardHeight);
    }
...
//    CGRect frame = CGRectMake(0, kScreenH - 64 - 40 - kChatToolBarHeight, kScreenWidth, kChatKeyBoardHeight);
