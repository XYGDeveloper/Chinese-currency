...
- (void)ppAtt_fromZeroToNumber:(CGFloat)number formatBlock:(PPAFormatBlock)formatBlock;
/**
...
- (void)ppAtt_fromNumber:(CGFloat)numberA toNumber:(CGFloat)numberB duration:(CFTimeInterval)duration animationType:(PPCounterAnimationType)animationType formatBlock:(PPFormatBlock)formatBlock completeBlock:(PPCompletionBlock)completionBlock;
/**
 在指定时间内,富文本字体属性UILabel中的数字从 numberA -> numberB,
 可设置动画类型
